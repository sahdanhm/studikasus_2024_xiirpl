                    ...
                    <div class="nav">
                        ...
                        <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne"
                            ...
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="index.php?link=t-produk">Produk</a>
                                <a class="nav-link" href="index.php?link=t-petugas">Petugas</a>
                                <a class="nav-link" href="index.php?link=t-pelanggan">Pelanggan</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePages" aria-labelledby="headingOne"
                            data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link" href="index.php?link=kasir">Penjualan</a>
                            </nav>
                        </div>

                        <a class="nav-link" href="index.php?link=lapor">
            ...
            <footer class="py-4 bg-light mt-auto">
                <div class="container-fluid px-4">
                    <div class="d-flex align-items-center justify-content-between small">
                        <div class="text-muted">Copyright UKK 2024 YOSEP</div>

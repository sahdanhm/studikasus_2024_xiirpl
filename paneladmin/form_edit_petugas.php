						...
						<form action="" method="post">
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="txtid"
									value="<?php echo $tampil['idpetugas']; ?>">
							</div>
							<div class="mb-3">
								<label class="form-label">Nama Petugas</label>
								<input type="text" class="form-control" name="txtnm"
									value="<?php echo $tampil['namapetugas']; ?>">
							</div>
							<div class="mb-3">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="contact"
									value="<?php echo $tampil['telppetugas']; ?>">
							</div>
							<div class="mb-3">
							...
							<button type="submit" class="btn btn-primary text-white" name="ubah">Simpan
								Perubahan</button>
						</form>
						<?php

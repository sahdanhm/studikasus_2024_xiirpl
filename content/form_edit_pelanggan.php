					...
					<div class="card-body">
						<form action="" method="post">
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="txtid" value="<?php echo $tampil['idpelanggan']; ?>">
							</div>
							<div class="mb-3">
								<label class="form-label">Nama</label>
								<input type="text" class="form-control" name="txtnm" value="<?php echo $tampil['namapelanggan']; ?>">
							</div>
							<div class="mb-3">
								<label class="form-label">Alamat</label>
								<input type="text" class="form-control" name="almt" value="<?php echo $tampil['alamatpelanggan']; ?>">
							</div>
							<div class="mb-3">
								<label class="form-label">Contact</label>
								<input type="text" class="form-control" name="tlp" value="<?php echo $tampil['telepon']; ?>">
							</div>

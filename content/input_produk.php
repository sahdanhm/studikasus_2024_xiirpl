				...
				<div class="card">
					...
					<div class="card-body">
						<form action="" method="post">
							...
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingInput" name="txtnm" placeholder="Masukan Nama Produk">
								<label for="floatingInput">Nama Produk</label>
							</div>
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingInput" name="txtharga" placeholder="Masukan Harga Produk">
								<label for="floatingInput">Harga Produk</label>
							</div>
							<div class="form-floating mb-3">
								<input type="text" class="form-control" id="floatingInput" name="txtstok" placeholder="Masukan Stok Produk">

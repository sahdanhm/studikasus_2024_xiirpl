 <?php
    ...
    $sql = mysqli_query($koneks, "select*from produk,penjualan,detailpenjualan where detailpenjualan.idproduk = produk.idproduk and detailpenjualan.idpenjualan = penjualan.idpenjualan and penjualan.idpenjualan = '$idpen' and produk.idproduk = '$idpro'");
    ?>
